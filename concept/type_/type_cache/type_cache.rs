...
use crate::type_::type_cache::{kind_cache_constructors, selection};
...
impl TypeCache {
    ...
    pub fn new<D>(
        ...
        let entity_type_caches = kind_cache_constructors::create_entity_type_caches(&snapshot);
        let relation_type_caches = kind_cache_constructors::create_relation_type_cache(&snapshot);
        let role_type_caches = kind_cache_constructors::create_role_caches(&snapshot);
        let attribute_type_caches = kind_cache_constructors::create_attribute_caches(&snapshot);

        let entity_types_index_label = kind_cache_constructors::build_label_to_type_index(&entity_type_caches);
        let relation_types_index_label = kind_cache_constructors::build_label_to_type_index(&relation_type_caches);
        let role_types_index_label = kind_cache_constructors::build_label_to_type_index(&role_type_caches);
        let attribute_types_index_label = kind_cache_constructors::build_label_to_type_index(&attribute_type_caches);
        ...
        Ok(TypeCache {
            ...
            owns: kind_cache_constructors::create_owns_caches(&snapshot),
