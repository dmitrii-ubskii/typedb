...
@REM bazel --output_user_root=C:/bzl test --experimental_ui_max_stdouterr_bytes=-1 //test/assembly:assembly --test_output=streamed --enable_runfiles --test_env=PATH -- --snapshot
