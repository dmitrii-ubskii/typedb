...
def typeql():
    git_repository(
        ...
        commit = "75a37b2eb7b51c2273c80c236ca08dd4f66fc423",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typeql
    )
...
def typedb_behaviour():
    git_repository(
        ...
        commit = "8a055e719b626c46ec80a3d932a70fb79f006d42",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
